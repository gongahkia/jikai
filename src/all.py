...
input_ids = tokenizer.encode(f"Generate a scenario for the topics: {input_topic for input_topic in input_topic_array} with {num_parties} parties", return_tensors='pt')
