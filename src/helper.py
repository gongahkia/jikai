...
def extract_all_topics(corpus):
    ...
    """
    return list({entry["topic"] for entry in corpus})
...
def write_generic_log(log_filepath, all_topics, identifier="generic"):
    """
...
def update_generic_log(log_filepath, identifier="generic"):
    """
