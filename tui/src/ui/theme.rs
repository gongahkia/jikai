...
pub fn subtitle() -> Style { Style::default().fg(Color::White).add_modifier(Modifier::BOLD) }
pub fn normal() -> Style { Style::default().fg(FG) }
pub fn dim() -> Style { Style::default().fg(DIM) }
pub fn selected() -> Style { Style::default().fg(Color::Black).bg(ACCENT) }
...
pub fn input() -> Style { Style::default().fg(Color::White).bg(Color::DarkGray) }
pub fn border() -> Style { Style::default().fg(Color::DarkGray) }
pub fn header() -> Style { Style::default().fg(ACCENT).add_modifier(Modifier::BOLD) }
