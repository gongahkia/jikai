...
class TestDatabaseService:
    ...
    async def test_get_statistics(self, database_service):
        ...
        for i in range(10):
            request_data = {'topics': ['negligence'], 'law_domain': 'tort', 'number_parties': 2, 'complexity_level': 'intermediate'}
            response_data = {
    ...
    async def test_search_by_topics(self, database_service):
        ...
        for topics in topics_sets:
            request_data = {'topics': topics, 'law_domain': 'tort', 'number_parties': 2, 'complexity_level': 'intermediate'}
            response_data = {
